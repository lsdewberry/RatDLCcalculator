...
% in column 1 and toeoffs in column 2. The last entry may often be 0 or NaN.
    ...
    elseif segmentingMethod == 2
        [output(i).Hdutyfactor.avg, frameStrideLength, output(i).numcycles, strides, output(i).Hdutyfactor.std,output(i).Hstridelength.std, output(i).byEye,FSTOs]=fstoY(sHTx,sHTf, directionfactor,spotcheck, 1,[0 0 0], 'HT FSTO'); 
